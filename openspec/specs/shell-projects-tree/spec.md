# shell-projects-tree Specification

## Purpose
The shell's sidebar as a tree of every visible project and the live work nested under it (UC-033):
which rows exist, what they link to, when they leave, and how the icon rail and the mobile sheet stay
identical to the expanded panel. It answers "what is this project doing"; the Inbox (UC-026) answers
"what waits on me".
## Requirements
