...
[`docs/product/v1/08-backlog-shaping-rules.md`](../product/v1/08-backlog-shaping-rules.md),
...
## Required fields — [RULE-001](../product/v1/08-backlog-shaping-rules.md)
...
- **Value** — why this matters and to whom, in product terms. A value sentence naming a
  technology instead of an actor outcome is an anti-pattern ([RULE-007](../product/v1/08-backlog-shaping-rules.md)).
- **Main actor** — an `ACT-*` id from [`01-actors-and-responsibilities.md`](../product/v1/01-actors-and-responsibilities.md).
...
- **Business rules** — the `BR-*` ids the item must uphold ([`05-business-rules.md`](../product/v1/05-business-rules.md)).
- **Affected use cases** — the `UC-*` ids it realises ([`04-capabilities.md`](../product/v1/04-capabilities.md)).
...
## Slicing — [RULE-002](../product/v1/08-backlog-shaping-rules.md)
...
## Traceability — [RULE-003](../product/v1/08-backlog-shaping-rules.md)
...
issue is classified Product or Foundation ([RULE-005](../product/v1/08-backlog-shaping-rules.md)) —
enabling work is never smuggled inside a feature item.

## Sequencing — [RULE-004](../product/v1/08-backlog-shaping-rules.md)
...
## Open decisions — [RULE-006](../product/v1/08-backlog-shaping-rules.md)
