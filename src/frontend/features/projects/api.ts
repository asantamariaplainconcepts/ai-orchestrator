...
import type { CreatedProject, CreateProjectRequest, ProjectsView } from "./types";
...
export const projectsApi = {
  ...
  create: (request: CreateProjectRequest) => api.post<CreatedProject>(projectsPath, request),
